        ...
        Pager.prototype={
            ...
            createUITmp:function(copts,celem){ //cpgidx,ctotals,cboundaryLinks,cfirstText,cpageCount,clastText,cprevText,cnextText,cuiType,cspage,cepage
                ...
                if(copts.cuiType==='amazeui'){
                        ...
                        if (copts.cboundaryLinks === true) {
                            htm.push(' <li class=" pager-last ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0? 'am-disabled' : '') + '"><a href="#">尾页</a></li>');
                        }
                        ...
                        if(!celem.hasClass('pagination')){
                         ...
                         if (copts.cboundaryLinks === true) {
                            htm.push('<li  class=" pager-first ' + (copts.cpgidx === 0 || copts.ctotals<=0 ? 'disabled' : '') + '" ><a href="#">首页</a></li>');
                        }
                        ...
                        if (copts.cboundaryLinks === true) {
                            htm.push(' <li class=" pager-last ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0? 'disabled' : '') + '"><a href="#">尾页</a></li>');
                        }
                }else{
